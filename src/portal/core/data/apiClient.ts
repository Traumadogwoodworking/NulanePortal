import { buildApiUrl, buildDocuFitUrl, portalConfig } from "@/lib/config";
import { resolveDevMockResponse, isDevMockEnabled } from "@/lib/devMockApi";
import { getPortalAccessToken, logAuthFlow, logoutRejectedPortalSession } from "@/lib/portalAuth";
