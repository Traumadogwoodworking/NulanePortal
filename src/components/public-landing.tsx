  ...
  return (
    <main className="min-h-screen bg-[#e9ebf2] p-0 text-slate-900">
      <div className="flex min-h-screen w-full flex-col overflow-y-auto">
        ...
        <section id="product" className="flex items-center justify-center px-6 py-6 lg:px-8 lg:py-8">
        ...
        <section className="flex items-end justify-center px-6 py-6 lg:px-8 lg:py-8">
          <PublicFooter />
        </section>
      </div>
    </main>
