      ...
      <div className="relative z-10 mx-auto max-w-7xl">
        ...
        <div className="relative mx-auto mt-8 flex max-w-[84rem] flex-col items-center gap-10 md:mt-10">
          <div className="relative w-full max-w-[82rem]">
            <div className="absolute inset-0 -z-10 rounded-[3rem] bg-[radial-gradient(circle_at_center,rgba(37,99,235,0.12),transparent_45%),radial-gradient(circle_at_left,rgba(59,130,246,0.12),transparent_28%),radial-gradient(circle_at_right,rgba(245,158,11,0.1),transparent_28%)] blur-2xl" />
            <img
