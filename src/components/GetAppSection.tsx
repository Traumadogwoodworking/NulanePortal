  ...
  return (
    ...
    >
      <div className="relative z-10 w-full max-w-6xl">
        ...
        <div className="mx-auto mt-8 flex w-full max-w-xl flex-col gap-4 sm:flex-row sm:justify-center">
          <a
          ...
          {hasGooglePlay ? (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group flex flex-1 items-center justify-center gap-4 rounded-2xl bg-green-600 px-6 py-5 text-white shadow-[0_16px_48px_rgba(22,163,74,0.22)] transition hover:-translate-y-0.5 hover:bg-green-500 hover:shadow-[0_20px_56px_rgba(22,163,74,0.28)] no-underline"
            >
              <GooglePlayIcon className="h-9 w-9 shrink-0" />
              <div className="text-left">
                <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-green-100">Get it on</p>
