...
export type PortalBrandingMode =
  | "circleLogistics"
  | "definianInspection"
  | "inspectionTrac"
  | "nulaneSystems"
...
export const PORTAL_BRANDING_PRESETS: Record<PortalBrandingMode, PortalBrandPreset> = {
  ...
  circleLogistics: {
    mode: "circleLogistics",
    defaultOrganizationName: "Circle Logistics",
    defaultLogoUrl: withPortalBasePath("/media/circle-logistics-logo.png"),
    staticLogoUrl: withPortalBasePath("/media/circle-logistics-logo.png"),
    staticLogoNormalizedKeys: ["circle logistics", "circle"],
    appNavLogoUrl: withPortalBasePath("/media/circle-logistics-logo.png"),
    allowSnapshotLogoOverride: false,
    footerLogoUrl: null,
    showFooterLogo: false,
    portalBrandColor: "#005EA8",
    portalBrandAccentColor: "#1F8A4C",
    portalBrandLightColor: "rgba(0, 94, 168, 0.10)",
    auth0ClientId: "eijyn4526jk7DKPnAYVh6fjKOJ3DVvSX",
    auth0OrganizationId: "org_CMAIJll4MDttBnED",
    sidebarBgEnforced: "#ffffff",
    sidebarTextEnforced: "#072b49",
    sidebarLinkEnforced: "#24445e",
    sidebarLinkHoverEnforced: "#005EA8",
    topbarTextClassName: "text-[color:var(--brand)]",
    sidebarLogoShellClassName:
      "relative z-10 flex w-full items-center justify-center px-4 py-3 transition-transform duration-300 group-hover:translate-y-px",
    sidebarLogoImageClassName: "h-auto w-full max-w-[250px] object-contain",
    appNavLabel: "Circle Logistics Portal",
    ...
    sidebarHeaderStyle: {
      ...
      backgroundImage:
        "linear-gradient(135deg, rgba(0,94,168,0.06), rgba(31,138,76,0.04))",
    },
    sidebarContentClassName:
      "flex-1 overflow-y-auto px-3 space-y-4 py-4 custom-scrollbar",
    sidebarSectionLabelClassName:
      "px-2 mb-2 text-[10px] font-bold uppercase tracking-wider text-slate-400",
    sidebarFooterClassName:
      "sidebar-footer relative p-3 flex flex-col items-center justify-center gap-3 bg-transparent mt-2",
    sidebarProfileToggleClassName:
      "flex w-full items-center justify-start gap-3 rounded-xl border-2 border-slate-100 bg-white px-3 py-3 text-[12px] font-black uppercase tracking-widest text-slate-600 hover:border-slate-200 hover:text-slate-900 transition-all group",
    sidebarProfileAvatarClassName:
      "flex h-9 w-9 items-center justify-center rounded-full bg-[#005EA8] text-[18px] font-black uppercase tracking-[0.12em] text-white",
    sidebarProfileMetaLabelClassName: "text-[10px] text-slate-400",
    ...
    defaultBadgeLabel: "Circle Logistics Portal",
    defaultPowerBiEmbedUrl: null,
    defaultIsPaid: true,
  },
  nulaneSystems: {
...
export const ACTIVE_PORTAL_BRANDING: PortalBrandingMode =
  process.env.NEXT_PUBLIC_PORTAL_BRANDING === "circleLogistics"
    ? "circleLogistics"
